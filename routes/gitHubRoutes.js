...
// fetch("https://api.github.com/users/"+{userInfo.github}+"/projects")


// curl "https://api.github.com/users/{userInfo.github}/repos?access_token=$GITHUB_API_TOKEN" | grep -w clone_url